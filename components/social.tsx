...
const OpenCollectiveIcon: React.FC<IconSvgProps> = ({size = 24, width, height, ...props}) => {  return (
    <svg
        fill="none"
        height={size || height}
        viewBox="0 0 24 24"
...
const PatreonIcon: React.FC<IconSvgProps> = ({size = 24, width, height, ...props}) => {  return (
    <svg
        fill="none"
        height={size || height}
        viewBox="0 0 24 24"
...
const GithubIcon: React.FC<IconSvgProps> = ({size = 24, width, height, ...props}) => {  return (
    <svg height={size || height} viewBox="0 0 24 24" width={size || width} {...props}>
        <path
            clipRule="evenodd"
...
const NextJsIcon: React.FC<IconSvgProps> = ({size = 24, width, height, ...props}) => {  return (
    <svg
        aria-hidden="true"
        height={size || height}
        viewBox="0 0 256 256"
...
};const VercelIcon: React.FC<IconSvgProps> = ({width, height = 44, ...props}) => {  return (
    <svg
        fill="none"
        height={height}
...
const NpmIcon: React.FC<IconSvgProps> = ({width = "1em", height = "1em", ...props}) => {  return (
    <svg
        aria-hidden="true"
        fill="currentColor"
        focusable="false"
...
const NpmSmallIcon: React.FC<IconSvgProps> = ({width = "1em", height = "1em", ...props}) => {  return (
    <svg
        fill="currentColor"
        focusable="false"
        height={height}
...
// #E1251B
export const AdobeIcon: React.FC<IconSvgProps> = ({width = "1em", height = "1em", ...props}) => {  return (
    <svg
        aria-hidden="true"
        aria-label="Adobe"
        fill="currentColor"
...
const YarnIcon: React.FC<IconSvgProps> = ({width = "1em", height = "1em", ...props}) => {  return (
    <svg
        aria-hidden="true"
        fill="currentColor"
        focusable="false"
...
const PnpmIcon: React.FC<IconSvgProps> = ({width = "1em", height = "1em", ...props}) => {  return (
    <svg
        aria-hidden="true"
        fill="currentColor"
        focusable="false"
...
const AstroIcon: React.FC<IconSvgProps> = ({width = "1em", height = "1em", ...props}) => {  return (
...
const NewNextJSIcon: React.FC<IconSvgProps> = ({width = "1em", height = "1em", ...props}) => {  return (
    <svg aria-hidden="true" fill="none" focusable="false" height={height} width={width} {...props}>
        <mask
            height="26"
...
const RemixIcon: React.FC<IconSvgProps> = ({width = "1em", height = "1em", ...props}) => {  return (
    <svg
        aria-hidden="true"
        fill="none"
        focusable="false"
...
const ViteIcon: React.FC<IconSvgProps> = ({width = "1em", height = "1em", ...props}) => {  return (
    <svg
        aria-hidden="true"
        fill="none"
        focusable="false"
...
const StorybookIcon: React.FC<IconSvgProps> = ({width = "1em", height = "1em", ...props}) => {  return (
    <svg
        aria-hidden="true"
        fill="none"
        focusable="false"
...
const CodeSandboxIcon: React.FC<IconSvgProps> = ({width = "1em", height = "1em", ...props}) => {  return (
    <svg
        fill="none"
        height={height}
        viewBox="0 0 18 18"
...
const JavascriptIcon: React.FC<IconSvgProps> = ({width = "1em", height = "1em", ...props}) => {  return (
    <svg
        fill="currentColor"
        height={height}
        viewBox="0 0 24 24"
...
const TypescriptIcon: React.FC<IconSvgProps> = ({width = "1em", height = "1em", ...props}) => {  return (
    <svg
        fill="currentColor"
        height={height}
        viewBox="0 0 24 24"
...
const GoogleIcon: React.FC<IconSvgProps> = ({size = 24, width, height, ...props}) => {  return (
    <svg
        focusable="false"
        height={size || height}
        viewBox="0 0 24 24"
...
const FacebookIcon: React.FC<IconSvgProps> = ({width = "1em", height = "1em", ...props}) => {  return (
